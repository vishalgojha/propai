...
alter table public.public_property_leads
...
create index if not exists public_property_leads_stream_item_idx
  on public.public_property_leads (stream_item_id, created_at desc);
