    ...
    return (
      <div className="max-w-xl mx-auto mt-16">
        <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-2xl p-6">
          ...
          <input
            className="w-full px-3 py-2 rounded-lg bg-[var(--bg-surface)] border border-[var(--border)] text-sm mb-3"
  ...
  return (
    <div className="max-w-3xl mx-auto flex flex-col h-[calc(100vh-7rem)]">
      ...
      <div className="flex-1 overflow-y-auto space-y-3 pr-2 mb-4">
          ...
          <div
            ...
            className={`px-4 py-3 rounded-2xl text-sm leading-relaxed whitespace-pre-wrap ${
              m.role === "user"
                ...
                : "bg-[var(--bg-card)] border border-[var(--border)] mr-12"
            }`}
          >
            {m.content}
          </div>
        ...
        {loading && (
          <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-2xl px-4 py-3 mr-12 text-sm text-[var(--text-secondary)]">
            Thinking&hellip;
          </div>
        )}
        <div ref={bottomRef} />
      ...
      <div className="flex gap-2">
        <textarea
          className="flex-1 px-4 py-2.5 rounded-xl bg-[var(--bg-card)] border border-[var(--border)] text-sm resize-none"
          rows={1}
          placeholder="Ask about your data&hellip;"
          value={input}
