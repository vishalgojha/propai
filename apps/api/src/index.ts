...
import dmContactRoutes from './routes/dmContactRoutes';
...
app.use(ROUTE_PATHS.api.intelligence, flaggedRoutes);
app.use(ROUTE_PATHS.api.intelligence, brokerRoutes);
app.use(ROUTE_PATHS.api.intelligence, dmContactRoutes);
