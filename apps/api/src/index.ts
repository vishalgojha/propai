...
import wabroDeviceRoutes from './routes/wabroDeviceRoutes';
import wabroInternalRoutes from './routes/wabroInternalRoutes';
...
app.use(ROUTE_PATHS.wabroDevice.root, wabroDeviceRoutes);
app.use(ROUTE_PATHS.api.wabro, authMiddleware, wabroRoutes);
app.use(ROUTE_PATHS.api.internal, internalAuthMiddleware, wabroInternalRoutes);
