...
const LOCATION_ALIASES: AliasEntry[] = [
    ...
    { canonical: 'Kanjurmarg', city: 'Mumbai', aliases: ['kanjurmarg', 'kanjur marg', 'kanjur', 'kanjur east', 'kanjur west'] },
    ...
    { canonical: 'Nalasopara', city: 'Mumbai', aliases: ['nalasopara', 'nalla sopara', 'nallasopara', 'nala sopara', 'vasai nalasopara'] },
