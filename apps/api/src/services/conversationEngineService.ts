...
export class ConversationEngineService {
    async process(input: ConversationEngineInput): Promise<ConversationEngineResult> {
        ...
        // NOTE: general_answer shortcut removed — the router never generates a reply.
        // The main AI model always runs with full conversation history so the user
        // has context continuity across turns.
