export const ROUTE_PATHS = {
  ...
  wabro: {
    ...
    campaignPause: '/campaigns/:id/pause',
    campaignStop: '/campaigns/:id/stop',
    contacts: '/contacts',
    ...
    messagesSendMedia: '/messages/send-media',
    mediaUpload: '/media/upload',
    events: '/events',
    groups: '/groups',
    groupParticipants: '/groups/:groupId/participants',
  },
  wabroDevice: {
    root: '/api/wabro/device',
    register: '/register',
