...
import { Search, Filter, MoreVertical, User, MapPin, DollarSign, Calendar, CheckCircle } from 'lucide-react';
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="relative">
                            ...
                            <input 
                                ...
                                className="bg-white/5 border border-white/10 rounded-full py-1.5 pl-10 pr-4 text-sm focus:outline-none focus:ring-2 focus:ring-white/20 w-64"
                            />
                        </div>
                    </div>
