                    ...
                    <div className="h-full glass border-r border-white/10 flex flex-col">
                        ...
                        <div className="flex-1 overflow-y-auto px-2 space-y-1">
                            {conversations.map((chat) => (
                                <button key={chat.jid} onClick={() => setSelectedChat(chat.jid)} className={`w-full flex items-center gap-3 p-3 rounded-2xl ${selectedChat === chat.jid ? 'bg-white text-black' : 'hover:bg-white/5 text-gray-400'}`}>
