...
export default function Listings() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-5 py-12 space-y-10">
      <Helmet>
        <title>Off-Market Real Estate Listings Mumbai | PropAI Pulse</title>
        <meta name="description" content="Browse real-time off-market properties in Mumbai. Filter by locality, price, and typology. Sourced directly from broker broadcasts." />
        <meta property="og:title" content="Real-Time Mumbai Property Intelligence | PropAI Pulse" />
      </Helmet>
