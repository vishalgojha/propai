...
export default function ListingDetail() {
  ...
  if (!listing) return (
     <div className="py-32 text-center mx-auto max-w-7xl px-5">
        ...
        <Link to="/listings" className="mt-8 inline-block text-[11px] font-bold uppercase tracking-[0.1em] text-[var(--accent)] hover:underline">
  ...
  return (
    <div className="mx-auto max-w-7xl px-5 py-8 space-y-10">
      ...
      <nav className="flex items-center gap-2 text-[11px] font-medium text-[var(--text-secondary)]">
        ...
        <Link to="/listings" className="hover:text-[var(--accent)] transition-colors">Listings</Link>
        <ChevronRight className="h-3 w-3" />
      ...
      {related.length > 0 && (
        <section className="pt-24 space-y-10">
           <div className="flex items-baseline justify-between mb-8 border-b border-white/[0.03] pb-6">
              ...
              <Link to="/listings" className="text-[12px] font-bold uppercase tracking-[0.2em] text-[var(--accent)] hover:brightness-110 transition-all">
