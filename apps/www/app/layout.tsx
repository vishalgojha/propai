...
export const metadata: Metadata = {
  title: "PropAI Pulse | Real-Time Off-Market Real Estate",
  description:
    "Access India's off-market property inventory with real-time AI market signals across top localities.",
