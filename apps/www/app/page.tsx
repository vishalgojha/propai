  ...
  return (
    <main>
      <section className="mx-auto max-w-2xl px-5 pt-14 pb-8 text-center">
        <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#5DCAA5] bg-[#E1F5EE] px-3.5 py-1.5 text-xs text-[#085041]">
          <span className="live-dot h-1.5 w-1.5 rounded-full bg-[#1D9E75]" />
        ...
        <h1 className="text-[30px] font-medium leading-tight text-white">
          ...
          <em className="not-italic text-[#1D9E75]">Straight from broker networks.</em>
        </h1>
      ...
      <section className="mx-auto max-w-7xl px-5 py-8">
        ...
        <div className="flex items-end justify-between">
          ...
          <Link href="/listings" className="shrink-0 text-sm text-[#1D9E75] hover:underline">
            Browse all &rarr;
          </Link>
        </div>
        ...
        <div className="mt-6 flex flex-col gap-2.5">
          ...
          <div className="flex items-center justify-center gap-1.5 rounded-2xl border border-[#243040] bg-[#111820] py-4 text-sm text-[#94a3b8]">
            ...
            <Link href="/listings" className="font-medium text-[#1D9E75] hover:underline">
              Browse all &rarr;
            </Link>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-8">
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {[
            { icon: "⏱️", bg: "bg-[#E1F5EE]", title: "Minutes, not days", desc: "Listings appear here within minutes of a broker posting on WhatsApp. 99acres gets it days later &mdash; if at all." },
            ...
            <div key={i} className="rounded-2xl border border-[#243040] bg-[#121a24]/80 p-4">
              <div className={`mb-3 flex h-8 w-8 items-center justify-center rounded-lg ${item.bg} text-sm text-[#0F6E56]`}>
                {item.icon}
              </div>
        ...
        <div className="mt-5 space-y-0">
          {[
            ...
            <div key={i} className="flex gap-4 border-b border-[#243040] py-4 last:border-b-0">
              <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#1D9E75] text-xs font-medium text-white">
                {step.num}
              </div>
              <div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-8">
        <div className="flex items-center gap-5 rounded-2xl border border-[#243040] bg-[#121a24]/80 p-5">
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#E1F5EE] text-xl text-[#1D9E75]">
          ...
          <div>
            ...
            <Link href="/broker/signup" className="mt-2 inline-flex items-center gap-1 text-xs font-medium text-[#1D9E75] hover:underline">
      ...
      <section className="border-t border-[#243040] px-5 py-10 text-center">
        ...
        <div className="mt-5 flex flex-wrap justify-center gap-3">
          <Link
            href="/listings"
            className="rounded-xl bg-[#1D9E75] px-5 py-2.5 text-sm font-medium text-white hover:brightness-110"
          >
