      ...
      <div className="rounded-[14px] border border-[color:var(--border)] bg-[var(--bg-surface)] p-6 md:p-8">
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <div className="rounded-[12px] border border-[color:var(--border)] bg-[var(--bg-elevated)] px-4 py-3">
            ...
            <p className="text-[11px] text-[var(--text-secondary)]">Trial 7 days free, Personal Parser ₹1499 bi-annual for 2 devices, PropAI Network ₹999, Team ₹2999/mo for 5 devices, WaBro ₹499 bi-annual.</p>
            {isAtDeviceLimit ? (
