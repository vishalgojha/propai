...
export default function Dashboard() {
    ...
    const fetchStream = async () => {
        try {
            const res = await apiFetch('/api/intelligence/stream?hours=24&limit=12');
            const data = await res.json();
                ...
                <div className="w-80 glass border-l border-white/10 flex flex-col p-6">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="pt-6 border-t border-white/10">
                            <label className="text-xs uppercase text-gray-500 font-bold mb-3">Fresh Stream</label>
                            <div className="space-y-3 max-h-64 overflow-y-auto">
                                {streamItems.length === 0 && (
                                    <p className="text-xs text-gray-600 italic">
                                        No parsed stream items yet. New watched group messages will appear here after ingestion.
                                    </p>
                                )}
