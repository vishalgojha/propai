...
const variantClasses: Record<NonNullable<AuthCardProps['variant']>, string> = {
  ...
  accent:
    'rounded-[14px] border border-[color:var(--accent-border)] bg-[linear-gradient(180deg,rgba(13,17,23,0.98),rgba(9,13,18,0.98))] shadow-[0_0_0_1px_rgba(62,232,138,0.08),0_24px_80px_rgba(0,0,0,0.35)]',
};
